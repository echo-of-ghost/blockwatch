...
### Fixed
- **Block chime fires during IBD and offline catch-up**: Audio now only plays for live blocks — tip timestamp must be within 20 minutes of the current time. Previously the chime fired on every block during initial sync or when coming back online after being offline, causing repeated rapid chiming.
